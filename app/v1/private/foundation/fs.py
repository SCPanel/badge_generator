...
# TODO: Make single finction for downloading files
...
async def upload_default_avatar_event(id: str, file: UploadFile = File(...), current_user: Dict[str, Any] = Depends(get_current_user)):
    ...
    # Check if the file extension is valid
    if file_extension.lower() != "ttf":
        return await raise_error_event(400, "Invalid file format. Only ttf are allowed.")

    # Change the file name to "template" + the file extension
    file_name = "font" + file_extension
